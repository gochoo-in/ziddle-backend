...
// CORS configuration
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:5173', 'http://devsuperadminziddle.s3-website.ap-south-1.amazonaws.com', 'http://build.d10tpduw9hjv1q.amplifyapp.com/', 'http://beta.admin.ziddle.tech', 'http://beta.admin.ziddle.tech.s3-website.ap-south-1.amazonaws.com'],
